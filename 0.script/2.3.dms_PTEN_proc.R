...
dms_gene<-read.table(paste0(data_folder,"PTEN&TPMT/DMS_PTEN_abundance.txt"),quote="",header=T,sep="\t",fill=TRUE)
...
topo_trend<-read.table(paste0(data_folder,"PTEN&TPMT/AA_topology_AF-P60484-F1-model_v4_chains.csv"),quote="",header=T,sep=",",fill=TRUE)
